...
/**
 * @brief Computes the normalized histogram of pairwise correlations between rows or columns of a matrix.
 *
...
correlation_histogram(const arma::Mat<T>& M, const double delta = 2.0, const bool by_row = true)
{
