...
std::vector<ReplicaState> compute_model_statistics(
    ...
    arma::Col<double> &mode_moment_2, arma::Col<double> &model_moment_3, double q, double beta, bool compute_triplets,
    double *avg_energy = nullptr, double *avg_energy_sq = nullptr, int top_k = 0);
